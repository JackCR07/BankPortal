/**
 * Title:        _GetCuentasConsumer_Default
 *
 ...
 *
 * This code was automatically generated at 04:43:36 PM on May 20, 2015
 ...
 *
 */
package genjava.consumers.GetCuentas;
 ...
 */
public class _GetCuentasConsumer_Default  implements IExemplar
{
...
{
   return new _GetCuentasConsumer_Default();
}

/*begin*/
/**
 * Generated Method [GetCuentasServiceGetCuentasSO]
 */
public IXml GetCuentasServiceGetCuentasSO(WebAppAccess webAppAccess)
{
//	The following webapp variables should be populated prior to invoking this method.
//	GetCuentasServiceGetCuentasSOInputs

	Object result = webAppAccess.callMethod("GetCuentasService.executeOperation", "GetCuentasSO", Boolean.FALSE );
...
/**
 * Generated Method [GetCuentasServiceGetCuentasSOWithArgs]
 */
public IXml GetCuentasServiceGetCuentasSOWithArgs(WebAppAccess webAppAccess, String arg1, String arg2, String arg3, String arg4, String arg5, String arg6)
{
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"GetCuentasServiceGetCuentasSOInputs/operation1/id_cliente", arg1, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"GetCuentasServiceGetCuentasSOInputs/operation1/id_tipo_cuenta", arg2, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"GetCuentasServiceGetCuentasSOInputs/operation1/fecha_mayor_a", arg3, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"GetCuentasServiceGetCuentasSOInputs/operation1/fecha_menor_a", arg4, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"GetCuentasServiceGetCuentasSOInputs/operation1/saldo_mayor_a", arg5, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"GetCuentasServiceGetCuentasSOInputs/operation1/saldo_menor_a", arg6, false );
	Object result = webAppAccess.callMethod("GetCuentasService.executeOperation", "GetCuentasSO", Boolean.TRUE );
	if (result instanceof WebAppAccessConsumer) {
		((WebAppAccessConsumer)result).setWebAppAccess(webAppAccess);
	}
	return (IXml)result;
...
{
    DataRetriever dr = (DataRetriever)PagingAssistant.findDataRetriever(webAppAccess, webAppAccess.getVariables().getObject("GetCuentasServiceGetCuentasSOResults"), true, true);
...
public void GetCuentasServiceView_InputPage_SaveData(WebAppAccess webAppAccess)
{
  ...
  IInputFieldFormatter formatter;
    ...
    {
        IXml GetCuentasServiceGetCuentasSOInputs = variables.getXml("GetCuentasServiceGetCuentasSOInputs");
        if (GetCuentasServiceGetCuentasSOInputs == null) {
            GetCuentasServiceGetCuentasSOInputs = XmlUtil.create("operation1");
            variables.setXml("GetCuentasServiceGetCuentasSOInputs", GetCuentasServiceGetCuentasSOInputs);
        }
            ...
            GetCuentasServiceGetCuentasSOInputs.setText("id_tipo_cuenta", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("fecha_mayor_a");
            formatter = (IInputFieldFormatter)variables.getObject("StandardFormatter");
            formatter.setWebAppAccess(webAppAccess);
            if (!formatter.validate(str, "Optional Date(yyyy-MM-dd)"))
              errors.addMessage("fecha_mayor_a", formatter.getErrorMessage());
            GetCuentasServiceGetCuentasSOInputs.setText("fecha_mayor_a", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("fecha_menor_a");
            formatter = (IInputFieldFormatter)variables.getObject("StandardFormatter");
            formatter.setWebAppAccess(webAppAccess);
            if (!formatter.validate(str, "Optional Date(yyyy-MM-dd)"))
              errors.addMessage("fecha_menor_a", formatter.getErrorMessage());
            GetCuentasServiceGetCuentasSOInputs.setText("fecha_menor_a", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("saldo_mayor_a");
            GetCuentasServiceGetCuentasSOInputs.setText("saldo_mayor_a", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("saldo_menor_a");
            GetCuentasServiceGetCuentasSOInputs.setText("saldo_menor_a", str);
    
        variables.getVariable("GetCuentasServiceGetCuentasSOInputs").notifyValueChanged();
    }
}
...
public com.bowstreet.builderutilities.PageAutomationMessages _init_GetCuentasServiceView_InputPageError(WebAppAccess webAppAccess)
{
    ...
    result.setReadableName("id_tipo_cuenta", "Tipo de Cuenta");
    result.setReadableName("fecha_mayor_a", "Fecha Desde");
    result.setReadableName("fecha_menor_a", "Fecha Hasta");
    result.setReadableName("saldo_mayor_a", "Saldo Inferior");
    result.setReadableName("saldo_menor_a", "Saldo Superior");
...
public Object GetCuentasServiceView_ShowResults(WebAppAccess webAppAccess)
{
    ...
    // Line 1: GetCuentasServiceGetCuentasSO
    returnValue = webAppAccess.callMethod("GetCuentasServiceGetCuentasSO", new Object[] {  });
