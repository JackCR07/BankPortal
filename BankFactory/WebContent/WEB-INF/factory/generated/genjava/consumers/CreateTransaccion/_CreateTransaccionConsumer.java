/**
 * Title:        _CreateTransaccionConsumer
 *
 ...
 *
 * This code was automatically generated at 11:32:12 AM on Apr 15, 2015
 ...
 */
public class _CreateTransaccionConsumer  implements IExemplar
{
...
{
   return new _CreateTransaccionConsumer();
}

/*begin*/
/**
 * Generated Method [CreateTransaccionCreateTransaccionSO]
 */
public IXml CreateTransaccionCreateTransaccionSO(WebAppAccess webAppAccess)
{
//	The following webapp variables should be populated prior to invoking this method.
//	CreateTransaccionCreateTransaccionSOInputs

	Object result = webAppAccess.callMethod("CreateTransaccion.executeOperation", "CreateTransaccionSO", Boolean.FALSE );
...
/**
 * Generated Method [CreateTransaccionCreateTransaccionSOWithArgs]
 */
public IXml CreateTransaccionCreateTransaccionSOWithArgs(WebAppAccess webAppAccess, String arg1, String arg2, String arg3, String arg4)
{
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"CreateTransaccionCreateTransaccionSOInputs/operation1/id_cuenta_origen", arg1, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"CreateTransaccionCreateTransaccionSOInputs/operation1/id_cuenta_destino", arg2, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"CreateTransaccionCreateTransaccionSOInputs/operation1/id_tipo_transaccion", arg3, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"CreateTransaccionCreateTransaccionSOInputs/operation1/monto_transferido", arg4, false );
	Object result = webAppAccess.callMethod("CreateTransaccion.executeOperation", "CreateTransaccionSO", Boolean.TRUE );
	if (result instanceof WebAppAccessConsumer) {
		((WebAppAccessConsumer)result).setWebAppAccess(webAppAccess);
	}
	return (IXml)result;
...
{
    DataRetriever dr = (DataRetriever)PagingAssistant.findDataRetriever(webAppAccess, webAppAccess.getVariables().getObject("CreateTransaccionCreateTransaccionSOResults"), true, true);
...
public void CreateTransaccionView_InputPage_SaveData(WebAppAccess webAppAccess)
{
  ...
  IInputFieldFormatter formatter;
    ...
    {
        IXml CreateTransaccionCreateTransaccionSOInputs = variables.getXml("CreateTransaccionCreateTransaccionSOInputs");
        if (CreateTransaccionCreateTransaccionSOInputs == null) {
            CreateTransaccionCreateTransaccionSOInputs = XmlUtil.create("operation1");
            variables.setXml("CreateTransaccionCreateTransaccionSOInputs", CreateTransaccionCreateTransaccionSOInputs);
        }
        
            str = webAppAccess.getRequestInputs().getInputValue("id_cuenta_origen");
            CreateTransaccionCreateTransaccionSOInputs.setText("id_cuenta_origen", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("id_cuenta_destino");
            CreateTransaccionCreateTransaccionSOInputs.setText("id_cuenta_destino", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("id_tipo_transaccion");
            CreateTransaccionCreateTransaccionSOInputs.setText("id_tipo_transaccion", str);
        
            str = webAppAccess.getRequestInputs().getInputValue("monto_transferido");
            CreateTransaccionCreateTransaccionSOInputs.setText("monto_transferido", str);
    
        variables.getVariable("CreateTransaccionCreateTransaccionSOInputs").notifyValueChanged();
    }
}
...
public Object CreateTransaccionView_ShowResults(WebAppAccess webAppAccess)
{
    ...
    // Line 1: CreateTransaccionCreateTransaccionSO
    returnValue = webAppAccess.callMethod("CreateTransaccionCreateTransaccionSO", new Object[] {  });
