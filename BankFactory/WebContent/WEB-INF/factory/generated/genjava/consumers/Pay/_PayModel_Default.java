 ...
 *
 * This code was automatically generated at 12:27:48 AM on Apr 30, 2015
 ...
 */
public class _PayModel_Default  implements IExemplar
{
...
{
   return new _PayModel_Default();
}

/*begin*/
/**
 * Generated Method [PayConsumerServicePayOperation]
 */
public IXml PayConsumerServicePayOperation(WebAppAccess webAppAccess)
{
//	The following webapp variables should be populated prior to invoking this method.
//	PayConsumerServicePayOperationInputs

	Object result = webAppAccess.callMethod("PayConsumerService.executeOperation", "PayOperation", Boolean.FALSE );
...
/**
 * Generated Method [PayConsumerServicePayOperationWithArgs]
 */
public IXml PayConsumerServicePayOperationWithArgs(WebAppAccess webAppAccess, String arg1, String arg2, String arg3, String arg4)
{
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"PayConsumerServicePayOperationInputs/operation1/id_cuenta_origen", arg1, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"PayConsumerServicePayOperationInputs/operation1/numero_cuenta_destino", arg2, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"PayConsumerServicePayOperationInputs/operation1/id_tipo_transaccion", arg3, false );
	com.bowstreet.builderutilities.PageAutomationRuntime.assign(webAppAccess,"PayConsumerServicePayOperationInputs/operation1/monto_transferido", arg4, false );
	Object result = webAppAccess.callMethod("PayConsumerService.executeOperation", "PayOperation", Boolean.TRUE );
	if (result instanceof WebAppAccessConsumer) {
		((WebAppAccessConsumer)result).setWebAppAccess(webAppAccess);
	}
	return (IXml)result;
...
/**
 * Generated Method [PayConsumerService_createHelper]
 */
public Object PayConsumerService_createHelper(WebAppAccess webAppAccess)
{
    ...
    helper.setName("PayConsumerService");
    return helper;
}
...
/**
 * Generated Method [CuentasPagosGetXmlData]
 */
public IXml CuentasPagosGetXmlData(WebAppAccess webAppAccess)
{
  // Extract the XML content, if any.  Otherwise ignore the content.
  final Object content = webAppAccess.getVariables().getObject("CuentasPagosXmlData");
  return (content instanceof IXml) ? (IXml) CuentasPagosFilterXml( webAppAccess, (IXml) content ) : null;
}


/**
 * Generated Method [CuentasPagosGetValueTagName]
 */
public String CuentasPagosGetValueTagName(WebAppAccess webAppAccess)
{
  return "Value";
}

/**
 * Generated Method [CuentasPagosGetLabelTagName]
 */
public String CuentasPagosGetLabelTagName(WebAppAccess webAppAccess)
{
  return "Label";
}

/**
 * Generated Method [CuentasPagosGetParentTagName]
 */
public String CuentasPagosGetParentTagName(WebAppAccess webAppAccess)
{
  return "UserAddition";
}

/**
 * Generated Method [CuentasPagosToLabel]
 */
public String CuentasPagosToLabel(WebAppAccess webAppAccess, String value)
{
  if (value == null) return null;
  String label = null;
  ...
  try
  {
    // Get the tag names that identify the value and label elements
    // in the source data XML.
    final String valueTagName = CuentasPagosGetValueTagName(webAppAccess);
    final String labelTagName = CuentasPagosGetLabelTagName(webAppAccess);
    ...
    // is either provided by the modeller directly or is created from
    // the additional data input of the lookup table builder.
    final IXml additionalDataXml = DataConverter.toIXml(webAppAccess.getVariables().getObject("CuentasPagosAdditionalXmlData"));
    String labelFromAdditionalData = null;
    ...
    if( label == null )
    {
      ...
      final IXml lookupTable = (IXml) webAppAccess.callMethod( "CuentasPagosGetXmlData" );
...
/**
 * Generated Method [CuentasPagosToValue]
 */
public String CuentasPagosToValue(WebAppAccess webAppAccess, String label)
{
  if (label == null) return null;
  String value = null;
...
/**
 * Generated Method [CuentasPagosFilterXml]
 */
public IXml CuentasPagosFilterXml(WebAppAccess webAppAccess, IXml data)
{
  String labelTag = CuentasPagosGetLabelTagName(webAppAccess);
  String valueTag = CuentasPagosGetValueTagName(webAppAccess);
  if (StringUtil.isEmpty(labelTag) || StringUtil.isEmpty(valueTag))
    return data;
  data = data.cloneElement();
  java.util.List rows = data.getChildren();
...
/**
 * Generated Method [CuentasPagosGetLookupTable]
 */
public IXml CuentasPagosGetLookupTable(WebAppAccess webAppAccess)
{
  // Fetch the content of the main lookup table.  If no main table
  // exists, then create an empty one as a default.
  IXml lookupTable = (IXml) webAppAccess.callMethod( "CuentasPagosGetXmlData" );
  lookupTable = (lookupTable == null) ? XmlUtil.create( "LookupTable" ) : lookupTable.cloneElement();
  ...
  if( additionalDataXml != null )
  {
    ...
    final String valueTagName = CuentasPagosGetValueTagName(webAppAccess);
    final String labelTagName = CuentasPagosGetLabelTagName(webAppAccess);
    final String parentTagName = CuentasPagosGetParentTagName(webAppAccess);
...
/**
 * Generated Method [PayConsumerView_InputPage_SaveData]
 */
public void PayConsumerView_InputPage_SaveData(WebAppAccess webAppAccess)
{
  String str;
  boolean performValidation;
  Variables variables = webAppAccess.getVariables();
  IInputFieldFormatter formatter;
    PageAutomationMessages errors = (PageAutomationMessages)webAppAccess.getVariables().getObject("PayConsumerView_InputPageError");
    errors.clear();

    {
        IXml PayConsumerServicePayOperationInputs = variables.getXml("PayConsumerServicePayOperationInputs");
        if (PayConsumerServicePayOperationInputs == null) {
            PayConsumerServicePayOperationInputs = XmlUtil.create("operation1");
            variables.setXml("PayConsumerServicePayOperationInputs", PayConsumerServicePayOperationInputs);
        }
            ...
            PayConsumerServicePayOperationInputs.setText("id_cuenta_origen", str);
            ...
            PayConsumerServicePayOperationInputs.setText("numero_cuenta_destino", str);
            ...
            PayConsumerServicePayOperationInputs.setText("monto_transferido", str);
    
        variables.getVariable("PayConsumerServicePayOperationInputs").notifyValueChanged();
    }
}

/**
 * Generated Method [_init_PayConsumerView_InputPageError]
 */
public com.bowstreet.builderutilities.PageAutomationMessages _init_PayConsumerView_InputPageError(WebAppAccess webAppAccess)
{
    PageAutomationMessages result = new PageAutomationMessages();

    result.setReadableName("id_cuenta_origen", "Cuenta de Origen");
    result.setReadableName("numero_cuenta_destino", "Servicio a Pagar");
...
/**
 * Generated Method [clear_PayConsumerView_InputPage_Errors]
 */
public void clear_PayConsumerView_InputPage_Errors(WebAppAccess webAppAccess)
{
  webAppAccess.callMethod("PayConsumerView_InputPageError.clear");
}

/**
 * Generated Method [PayConsumerView_InputPage_NextAction]
 */
public void PayConsumerView_InputPage_NextAction(WebAppAccess webAppAccess)
{
    PageAutomationMessages errors = (PageAutomationMessages)webAppAccess.getVariables().getObject("PayConsumerView_InputPageError");
    ...
    if (action != null)
        ...
        webAppAccess.processAction("PayConsumerView_InputPage");
    else
        webAppAccess.processAction("PayConsumerView_ShowResults");
}
...
public Object main(WebAppAccess webAppAccess)
{
    ...
    // Line 2: PayConsumerView_InputPage
    returnValue = webAppAccess.processAction("PayConsumerView_InputPage");
    return (Object)returnValue;
}


/**
 * Generated ActionList [PayConsumerView_ShowResults]
 */
public Object PayConsumerView_ShowResults(WebAppAccess webAppAccess)
{
    Object returnValue = null;

    // Line 1: PayConsumerServicePayOperation
    returnValue = webAppAccess.callMethod("PayConsumerServicePayOperation", new Object[] {  });

    // Line 2: PayConsumerView_ViewPage
    returnValue = webAppAccess.processAction("PayConsumerView_ViewPage");
    return (Object)returnValue;
}
