...
var wpf_io8501201408181253={bind:function(_1){
wpf_io8501201408181253=typeof dojo!="undefined"?{bind:function(_2){
...
var _11=wpf_io8501201408181253.findElement(xh.xmlhttp.responseXML,"feed");
if(_11){
var _12=wpf_io8501201408181253.findElement(_11,"entry");
if(_12){
var c=wpf_io8501201408181253.findElement(_12,"content");
if(c&&c.firstChild){
...
return wpf_io8501201408181253.bind(_1);
}};
}
if(typeof wpf_ppr8501201408181253=="undefined"){
var wpf_ppr8501201408181253={submit:function(_19,_1a,_1b,_1c){
...
if(!_22){
_22=wpf_ppr8501201408181253.explicitHandler;
}
if(_22.prepare){
...
wpf_ppr8501201408181253.checkSessionTimeout(_27);
}
...
wpf_io8501201408181253.bind(_2e);
...
wpf_ppr8501201408181253.removeControls(_36[i]);
}
}
...
ok=wpf_ppr8501201408181253.explicitHandler.update(_3a,_3b,{execScripts:!_3e,useDojo:_3e});
if(ok){
...
var _43=wpf_ppr8501201408181253.wrapperPatterns[i];
...
wpf_ppr8501201408181253.buildWidgets(_46);
return true;
...
ok=wpf_ppr8501201408181253.explicitHandler.injectContent(document.body,_47,_49&&_49.useDojo);
}else{
tmp.innerHTML=_47;
var _4b=tmp.childNodes.length;
for(var n=0;n<_4b;n++){
var _4c=tmp.childNodes[n];
wpf_ppr8501201408181253.updateCSS(_4c,_48);
ok=wpf_ppr8501201408181253.explicitHandler.updateContent(_4c,_48,_49&&_49.useDojo)||ok;
}
}
if(_49&&_49.execScripts){
wpf_ppr8501201408181253.executeScripts(document,_48);
}
if(!_49||!_49.useDojo){
wpf_ppr8501201408181253.buildWidgets(_48);
}
tmp.innerHTML="";
return ok;
...
ok=wpf_ppr8501201408181253.explicitHandler.updateContent(c,_4e,_4f)||ok;
}
return ok;
...
_53=new wpf.widget.RefreshContainer({content:_51,executeScripts:true,renderStyles:true,cleanContent:(dst==document.body)},dst.id);
_53.startup();
try{
...
wpf_ppr8501201408181253.updateCSS(_57);
}
return;
}
if(!el){
...
wpf_ppr8501201408181253.executeScripts(_5a);
}
return;
}
if(!el){
...
var src=_60.src;
if(src){
wpf_ppr8501201408181253.addScriptReference({src:src,deferred:_5c});
}else{
_5c.addDeferred(_60);
}
}
...
window._wpf_ppr8501201408181253_global_eval(_61);
