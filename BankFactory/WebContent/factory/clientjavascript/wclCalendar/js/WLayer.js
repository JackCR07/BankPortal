...
function WLayer_getContentDimension()
{
    ...
    if ( container )
    {
    	...
    	if(contentElement.offsetWidth != 0 && contentElement.offsetHeight == 0)
		    ...
		    var childContentElement = contentElement.childNodes.item(x);
		    if ( childContentElement )
		    {
		    	if(childContentElement.offsetWidth == 0 || childContentElement.offsetHeight == 0)
		    		continue;
		        contentDimension = new Dimension( childContentElement.offsetWidth, childContentElement.offsetHeight );
		        break;
		    }
        }
    }
