...
/**
*
* This code was written by (and is owned by) the Apache (Axis) software group.
*/
->
...
<%!
    ...
    public String getFileVersion(File file) throws IOException {
        String key="<td  role=\"presentation\">"+file.getName()+"</td>";
        key+= "<td  role=\"presentation\">"+file.length()+"</td>";
        Date timestamp=new Date(file.lastModified());
        key+= "<td  role=\"presentation\">"+timestamp.toString()+"</td>";
        return key;
    ...
    public void listVersions(String title, JspWriter out,File[] jars, String comment) throws IOException {
        ...
        for (int i=0; i<jars.length; i++) {
            out.println("<tr  role=\"presentation\">"+getFileVersion(jars[i])+"</tr>");
        }
        out.println("</table>");
...
<tr  role="presentation">
    <td  role="presentation">Servlet Engine</td>
    <td  role="presentation"><%= getServletConfig().getServletContext().getServerInfo() %></td>
    <td  role="presentation"><%= getServletConfig().getServletContext().getMajorVersion() %></td>
    <td  role="presentation"><%= getServletConfig().getServletContext().getMinorVersion() %></td>
</tr>
<tr  role="presentation">
    <td  role="presentation">Java VM</td>
    <td  role="presentation"><%= System.getProperty("java.vm.vendor") %></td>
    <td  role="presentation"><%= System.getProperty("java.vm.name") %></td>
    <td  role="presentation"><%= System.getProperty("java.vm.version") %></td>
</tr>
<tr  role="presentation">
    <td  role="presentation">Java RE</td>
    <td  role="presentation"><%= System.getProperty("java.vendor") %></td>
    <td  role="presentation"><%= System.getProperty("java.version") %></td>
    <td  role="presentation"> </td>
</tr>
<tr  role="presentation">
    <td  role="presentation">Platform</td>
    <td  role="presentation"><%= System.getProperty("os.name") %></td>
    <td  role="presentation"><%= System.getProperty("os.arch") %></td>
    <td  role="presentation"><%= System.getProperty("os.version") %></td>
</tr>
</table>
