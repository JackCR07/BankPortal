...
<%
    ...
    */
    ...
    <table  role="presentation">
        <tr  role="presentation"><td  role="presentation">Servlet version</td><td  role="presentation"><%= servletVersion %></td></tr>
        <tr  role="presentation"><td  role="presentation">XML Parser</td><td  role="presentation"><%= xmlParser %></td></tr>
        <tr  role="presentation"><td  role="presentation">XML ParserLocation</td><td  role="presentation"><%= xmlParserLocation %></td></tr>
    </table>
